...
const stringmap_entry stringmap[LAST_KNOWN] = {
	...
	{ "depth", SLEN("depth") },
	{ "max-depth", SLEN("max-depth") },
	{ "min-depth", SLEN("min-depth") },
	{ "far", SLEN("far") },
	{ "near", SLEN("near") },
	{ "margin-far", SLEN("margin-far") },
	{ "margin-near", SLEN("margin-near") },
	{ "padding-far", SLEN("padding-far") },
	{ "padding-near", SLEN("padding-near") },
	{ "overflow-z", SLEN("overflow-z") },
	...
	{ "stack", SLEN("stack") },
	{ "stack-reverse", SLEN("stack-reverse") },
