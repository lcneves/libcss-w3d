...
enum {
	...
	DEPTH, MAX_DEPTH, MIN_DEPTH, FAR, NEAR, MARGIN_FAR, MARGIN_NEAR,
	PADDING_FAR, PADDING_NEAR, OVERFLOW_Z,

	LAST_PROP = OVERFLOW_Z,
	...
	COLUMN_REVERSE, WRAP_STRING, WRAP_REVERSE, STACK, STACK_REVERSE,
