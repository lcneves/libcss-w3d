...
enum css_properties_e {
	...
	CSS_PROP_DEPTH				= 0x07c,
	CSS_PROP_MAX_DEPTH			= 0x07d,
	CSS_PROP_MIN_DEPTH			= 0x07e,
	CSS_PROP_FAR				= 0x07f,
	CSS_PROP_NEAR				= 0x080,
	CSS_PROP_MARGIN_FAR			= 0x081,
	CSS_PROP_MARGIN_NEAR			= 0x082,
	CSS_PROP_PADDING_FAR			= 0x083,
	CSS_PROP_PADDING_NEAR			= 0x084,
	CSS_PROP_OVERFLOW_Z			= 0x085,
